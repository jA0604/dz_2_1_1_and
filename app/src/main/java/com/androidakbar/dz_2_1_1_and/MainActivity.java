package com.androidakbar.dz_2_1_1_and;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MainActivity.this, "Вы ввели сумму:" + etMoney.getText().toString() + " оплата: " + text + etInput.getText().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}